#!/usr/bin/env python3
"""Run turbulent_channel/2d/re590_k_ep_LS full training in dy and CINN modes."""
import os
import re
import subprocess
...
MODEL_PATH = 'turbulent_channel/2d/re590_k_ep_LS'
DIR_NAME = 'turbulent_channel-2d-re590_k_ep_LS'
