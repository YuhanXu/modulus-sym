...
# Inference benchmark for ode_spring_mass-spring_mass_solver.
...
function _infer(){
    ...
    infer_cmd="pushd examples/ode_spring_mass; python spring_mass_solver_infer.py training.max_steps=0; popd"
