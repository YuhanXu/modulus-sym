...
# Inference benchmark for waveguide-cavity_2D-waveguide2D_TMz.
...
function _infer(){
    ...
    infer_cmd="pushd examples/waveguide/cavity_2D; python waveguide2D_TMz_infer.py training.max_steps=0; popd"
