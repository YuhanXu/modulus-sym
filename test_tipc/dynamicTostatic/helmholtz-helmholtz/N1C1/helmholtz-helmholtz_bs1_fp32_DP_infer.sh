...
# copy files
\cp test_tipc/dynamicTostatic/helmholtz-helmholtz/benchmark_common/prepare.sh ./
\cp test_tipc/dynamicTostatic/helmholtz-helmholtz/benchmark_common_infer/run_benchmark.sh ./
\cp test_tipc/dynamicTostatic/helmholtz-helmholtz/benchmark_common/analysis_log.py ./
# prepare
bash prepare.sh
# run
