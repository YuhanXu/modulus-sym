...
# copy files
\cp test_tipc/dynamicTostatic/ode_spring_mass-spring_mass_solver/benchmark_common/prepare.sh ./
\cp test_tipc/dynamicTostatic/ode_spring_mass-spring_mass_solver/benchmark_common_infer/run_benchmark.sh ./
\cp test_tipc/dynamicTostatic/ode_spring_mass-spring_mass_solver/benchmark_common/analysis_log.py ./
# prepare
bash prepare.sh
# run
