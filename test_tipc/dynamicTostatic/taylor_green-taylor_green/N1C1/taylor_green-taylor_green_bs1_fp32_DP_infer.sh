...
# copy files
\cp test_tipc/dynamicTostatic/taylor_green-taylor_green/benchmark_common/prepare.sh ./
\cp test_tipc/dynamicTostatic/taylor_green-taylor_green/benchmark_common_infer/run_benchmark.sh ./
\cp test_tipc/dynamicTostatic/taylor_green-taylor_green/benchmark_common/analysis_log.py ./
# prepare
bash prepare.sh
# run
