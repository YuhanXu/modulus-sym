...
# copy files
\cp test_tipc/dynamicTostatic/wave_equation-wave_1d/benchmark_common/prepare.sh ./
\cp test_tipc/dynamicTostatic/wave_equation-wave_1d/benchmark_common_infer/run_benchmark.sh ./
\cp test_tipc/dynamicTostatic/wave_equation-wave_1d/benchmark_common/analysis_log.py ./
# prepare
bash prepare.sh
# run
